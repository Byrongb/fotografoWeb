            ...
            (w.animateScroll = function (i, s, e) {
                ...
                if (u || t) {
                        ...
                        b = function (e, t) {
                            ...
                            if (e == t || r == t || (l < t && C.innerHeight + r) >= v)
                                return (
                                    ...
                                    a || (n.focus(), document.activeElement !== n && (n.setAttribute("tabindex", "-1"), n.focus(), (n.style.outline = "none")), C.scrollTo(0, o)),
                                    Q("scrollStop", c, i, s),
                                    !(A = d = null)
                                );
                        },
                    ...
                    0 === C.pageYOffset && C.scrollTo(0, 0),
                        ...
                        "matchMedia" in C && C.matchMedia("(prefers-reduced-motion)").matches ? C.scrollTo(0, Math.floor(g)) : (Q("scrollStart", c, i, s), w.cancelScroll(!0), C.requestAnimationFrame(O));
                }
            });
        var t = function (e) {
                if (
                    ...
                    (t = t || "#top" !== n ? t : document.documentElement) &&
                        ...
                        (function (e) {
                            if (history.replaceState && e.updateURL && !history.state) {
                                ...
                                (t = t || ""), history.replaceState({ smoothScroll: JSON.stringify(e), anchor: t || C.pageYOffset }, document.title, t || C.location.href);
                            }
                        })(M),
                        w.animateScroll(t, a));
                }
